...
from django.urls import path, include  # Импортируйте include для подключения маршрутов приложения
...
urlpatterns = [
    ...
    path('', include('recipes.urls')),  # маршруты из вашего приложения recipes
]
